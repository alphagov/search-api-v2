RSpec.describe DiscoveryEngine::Quality::GcpBucketExporter do
  ...
  describe "file_name" do
    it "returns a filename that contains the required folder names" do
      ...
      expected_filename =
        "judgement_list=explicit/partition_date=2025-06-01/create_time=2025-06-01 12:30:00/results.json"
  ...
  describe "#send" do
    ...
    let(:file_name) { "judgement_list=explicit/partition_date=2025-06-01/create_time=2025-06-01 12:30:00/results.json" }
