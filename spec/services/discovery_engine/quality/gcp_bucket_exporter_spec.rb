RSpec.describe DiscoveryEngine::Quality::GcpBucketExporter do
  ...
  describe "file_name" do
    it "returns a filename that contains the required folder names" do
      ...
      expected_filename =
        "create_time=2025-06-01 12:30:00/judgement_list=explicit/partition_date=to-be-implemented/results.json"
  ...
  describe "#send" do
    ...
    let(:file_name) { "create_time=2025-06-01 12:30:00/judgement_list=explicit/partition_date=to-be-implemented/results.json" }
