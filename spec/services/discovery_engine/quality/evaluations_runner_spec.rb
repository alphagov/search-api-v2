RSpec.shared_context "with a table_id" do
  ...
  let(:evaluation_of_last_month) { double("evaluation", list_evaluation_results: "detailed_metrics", formatted_create_time: "time-stamp", full_partition_date: "date") }
  let(:query_set_month_before_last) { double("sample_query_set", table_id:, name: "/path/to/#{table_id}-month_before_last") }
  let(:evaluation_of_month_before_last) { double("evaluation", list_evaluation_results: "more_detailed_metrics", formatted_create_time: "time-stamp", full_partition_date: "date") }
